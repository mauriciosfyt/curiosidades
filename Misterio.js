...
const curiosidades = [
  ...
  'Os enormes Moais foram construídos por povos antigos, mas até hoje não se sabe como foram transportadas por quilômetros sem rodas ou animais.'
];

const Misterio = () => {
  const navigation = useNavigation();
  const [curiosidade, setCuriosidade] = useState(curiosidades[3]);
